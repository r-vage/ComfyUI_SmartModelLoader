        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Float.Input(
                    ...
                    step=0.01,
                    display_mode=SLIDER_DISPLAY,
                    tooltip="MiniMax H3 video flow shift. ComfyUI default: 12.0.",
                ),
                io.Float.Input(
                    "shift_audio",
                    default=3.0,
                    ...
                    step=0.01,
                    display_mode=SLIDER_DISPLAY,
                    tooltip="MiniMax H3 audio flow shift. ComfyUI default: 3.0.",
                ),
                io.Combo.Input(
                    "sampling_subtype",
                    options=[
